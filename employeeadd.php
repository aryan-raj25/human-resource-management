        ...
        <div class="vali-form-group">
          <div class="col-md-4 control-label">
            ...
            <div class="col-md-4 control-label">
              ...
              <input type="text" name="mname" title="Middel Name" value="<?php echo(isset($editemp["MiddleName"]))?$editemp["MiddleName"]:""; ?>" class="form-control" placeholder="Middle Name" required="">
              </div>
            </div>
